...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_8cy5fkr", "template_tztfauu", form.current, {
        publicKey: "iOBh4hlSQkNvFvWeZ",
      })
      .then(
        () => {
          setSuccess(true);
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>nalinsmalla@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
      ...
      <div className="formContainer">
        ...
        >
          <svg width="500px" height="500px" viewBox="0 0 100 100">
            <motion.path
              ...
              // whileInView={{ pathLength: 1 }} //didn't work
        ...
        >
          ...
          {error && "Error: Message was not emailed."}
          {success && "Success: Message has been emailed."}
        </motion.form>
      </div>
    </motion.div>
  );
